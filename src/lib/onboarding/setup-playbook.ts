 ...
 *
 * WHY THIS ORDER. Trade first, and it is not close: one answer decides the job codes we offer them
...
export const SETUP_PLAYBOOK: Playbook = {
  needs: [
    ...
    },
    {
      ...
      feeds: ["what"],
      why:
        "The one answer that lights up three dead surfaces: the starter job codes I can offer you, " +
        "the questions your walk-through asks on site, and what an estimate thinks it's pricing. " +
